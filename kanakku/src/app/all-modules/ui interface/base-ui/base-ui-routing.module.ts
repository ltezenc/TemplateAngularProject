    ...
    children: [
      { 
        ...
        { 
          path: 'badges', 
          loadChildren: () => 
            import('./badges/badges.module').then(
              (m) => m.BadgesModule) 
        },
        { 
          path: 'buttons', 
        ...
        { 
          path: 'lightbox', 
          loadChildren: () => 
            import('./lightbox/lightbox.module').then(
              (m) => m.LightboxModule) 
        },
        { 
          path: 'media', 
        ...
        { 
          path: 'modals', 
          loadChildren: () => 
            import('./modals/modals.module').then(
              (m) => m.ModalsModule) 
        },
        { 
          path: 'offcanvas', 
          loadChildren: () => 
            import('./offcanvas/offcanvas.module').then(
              (m) => m.OffcanvasModule) 
        },
        { 
          path: 'pagination', 
        ...
        { 
          path: 'toasts', 
          loadChildren: () => 
            import('./toasts/toasts.module').then(
              (m) => m.ToastsModule) 
        },
        { 
          path: 'tooltip', 
          loadChildren: () => 
            import('./tooltip/tooltip.module').then(
              (m) => m.TooltipModule) 
        },
        { 
          path: 'typography', 
